    ...
    return Stack(
      ...
      children: <Widget>[
        ...
        Positioned(
          top: -80,
          left: 60,
          child: FaIcon( this.icon, size: 250, color: Colors.black.withOpacity(0.2) )
        ),
        ...
        Column(
          children: <Widget>[
            ...
            SizedBox(height: 20),
            Text( this.titulo, style: TextStyle( fontSize: 35, color: Colors.white, fontWeight: FontWeight.bold ) ),
            SizedBox(height: 20),
